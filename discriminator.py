...
class Discriminator(nn.Module):
    ...
    def __init__(self, img_size, hidden_size, mbd_in_features=100, mbd_out_features=50, mbd_kernel_dims=25):
        super().__init__()
        ...
        self.disc = MinibatchDiscrimination(mbd_in_features, mbd_out_features, mbd_kernel_dims)
